            ...
            <div className="container-fluid">
                <div className="d-flex align-items-center ">
                    ...
                    <div className="col-sm-3 footer d-flex justify-content-center">
                        ...
                        {/* <h4>Contact Us</h4> */}
                            <ul className="list">
                                <li><Link to={'/faq'} onClick={()=> scrollToUpward('Team')}>FAQ</Link></li>
                                <li><Link to={'/team'} onClick={()=> scrollToUpward('Home')}>Join us</Link></li>
                                <li><Link to={'/mission'} onClick={()=> scrollToUpward('Home')}>Mission/Vision</Link></li>
                                <li><Link to={'/gallery'} onClick={()=> scrollToUpward('Home')}>Gallery</Link></li>
                                <li><Link to={'/partner'} onClick={()=> scrollToUpward('Home')}>Partner NGO</Link></li>
                                <li><Link to={'/bankPartner'} onClick={()=> scrollToUpward('Team')}>Our Partners</Link></li>
                ...
                <div className="horizontal-line text-white"><hr className="mt-0" /></div>
                ...
                <div className="policy-contentt col-sm-6 ">
                    <NavLink className='text-center' to={'/policy'} style={{textDecoration:'none'}}><span className="mx-3 text-white">PRIVATE POLICY</span></NavLink>
                    <NavLink className='text-center' to={'/conditions'} style={{textDecoration:'none'}}><span className="mx-3 text-white">TERMS & CONDITIONS</span></NavLink>
