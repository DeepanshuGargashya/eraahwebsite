      ...
      <div className="homepage-New">
        <div className="container">
          <div className="heading">
            <h3>Entirety of your contribution<br />goes to <span>serve your donatee</span></h3>
          </div>
          <div className="row my-5">
            <div className="col-lg-4 col-md-6 col-sm-12">
              <div className="boxes">
                <h5>You choose a <br />teacher</h5>
                <div className="circle">
                  <img src={homepageimg1} alt="image" width={'55%'} />
                </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              <div className="boxes">
                <h5>We track <br />progress</h5>
                <div className="circle">
                  <img src={homepageimg2} alt="image" width={'55%'} />
                </div>
                <p>Innovative educator fostering creativity and critical thinking in Indian classrooms. She teaches Art.</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12">
              <div className="boxes">
                <h5>The child <br />thanks you</h5>
                <div className="circle">
                  <img src={homepageimg3} alt="image" width={'55%'} />
                </div>
                <p>Innovative educator fostering creativity and critical thinking in Indian classrooms. She teaches Art.</p>
              </div>
            </div>
                ...
                <div className="row iconss">
                  <div className="col-6 imgbox">
                    <div className="circle-img">
                      <img src={homepageimg4} alt="image" width={'53%'} />
                    </div>
                    <h6>100% Transparency</h6>
                  </div>
                  <div className="col-6 imgbox">
                    <div className="circle-img">
                      <img src={homepageimg5} alt="image" width={'53%'} />
                    </div>
                    <h6>Track Your Impact</h6>
                  </div>
                  <div className="col-6 imgbox">
                    <div className="circle-img">
                      <img src={homepageimg6} alt="image" width={'53%'} />
                    </div>
                    <h6>Get Image Proof</h6>
                  </div>
                  <div className="col-6 imgbox">
                    <div className="circle-img">
                      <img src={homepageimg7} alt="image" width={'60%'} />
                    </div>
                    <h6>Money Breakdown</h6>
                  </div>
                </div>
              </div>
            </div>
